...
public class Numbers_01 {
	public static void main(String[] args) {
		 ...
		 * 그 값은 배열의 개수를 가리킨다.
		 * 
		 * 배열의 요소에 어떤 값을 저장할 대는
		 * intNums[위치] = 값 형식을 사용하는데
		 * 이 때 위치의 값을 "(배열)첨자"라고 한다.
		 * 
		 * intNums[3] = 100
		 * ==> intNums 배열 3번 첨자 위치에 100을 저장하라
		 * 
		 ...
		 * 
		 * sum = intNums[7] + 200
		 * ==> intNums 배열의 7번 첨자 위치에 저장된 값과 
		 * 		정수 200을 덧셈하여 변수 sum에 저장
		 * 
		 * 배열의 첨자 최대값을 항상 배열.length - 1 이다.
		 * ==> new int[100]이라고 배열을 생성했으면
		 * 		가장 마지막 첨자는 99가 된다.
		 * 만약 int intNums = new int[10] 라고 생성한 배열의
